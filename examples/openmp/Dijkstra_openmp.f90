...
subroutine dijkstra_distance ( nv, ohd, mind )
  ...
  !
  !    Input, integer :: OHD(NV,NV), the distance of the direct
  !    link between nodes I and J.
  !
  !    Output, integer :: MIND(NV), the minimum
...
subroutine find_nearest ( s, e, nv, mind, connected, d, v )
  ...
  !  Parameters:
  !
  !    Input, integer :: S, E, the first and last nodes that
  !    are to be checked.
  !
  !    Input, integer :: NV, the number of nodes.
  !
  !    Input, integer :: MIND(NV), the currently computed minimum
  !    distance from node 1 to each node.
  !
...
subroutine init ( nv, ohd )
  ...
  !    Input, integer :: NV, the number of nodes.
  !
  !    Output, integer :: OHD(NV,NV), the distance of the direct
  !    link between nodes I and J.
  !
  implicit none
...
subroutine update_mind ( s, e, nv, connected, ohd, mv, mind )
  ...
  !  Parameters:
  !
  !    Input, integer :: S, E, the first and last nodes that are
  !    to be checked.
  !
  !    Input, integer :: NV, the number of nodes.
  !
  ...
  !
  !    Input, integer :: OHD(NV,NV), the distance of the direct link
  !    between nodes I and J.
  !
  !    Input, integer :: MV, the node whose minimum distance to node 20
  !    has just been determined.
  !
  !    Input/output, integer :: MIND(NV), the currently computed
